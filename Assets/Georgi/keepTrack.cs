...
public class keepTrack : MonoBehaviour {
    ...
    double[,] red = { { 2.02, 2.83 }, { -3.740636, 13.88478 }, { 3.59, 2.86 }, { 2.79, 2.06 }, { -0.05, 3.1 }, { -0.05, 2.36 }, { -0.05, 1.62 }, { -0.05, 0.92 }, { -0.05, 0.02 }, };
    ...
    void Start () {
        ...
        greenPlayersPawns[1].transform.position = (new Vector3((float)green[2, 0], (float)green[2, 1], 0));
        greenPlayersPawns[1].transform.position = (new Vector3((float)green[3, 0], (float)green[3, 1], 0));
        ...
        redPlayersPawns[1].transform.position = (new Vector3((float)red[2, 0], (float)red[3, 1], 0));
        redPlayersPawns[1].transform.position = (new Vector3((float)red[4, 0], (float)red[4, 1], 0));
        ...
        bluePlayersPawns[1].transform.position = (new Vector3((float)blue[2, 0], (float)blue[2, 1], 0));
        bluePlayersPawns[1].transform.position = (new Vector3((float)blue[3, 0], (float)blue[3, 1], 0));
        ...
        yellowPlayersPawns[1].transform.position = (new Vector3((float)yellow[2, 0], (float)yellow[2, 1], 0));
        yellowPlayersPawns[1].transform.position = (new Vector3((float)yellow[3, 0], (float)yellow[3, 1], 0));
    }
